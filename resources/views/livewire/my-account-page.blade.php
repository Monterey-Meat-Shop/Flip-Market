...
<main x-data="{ tab: 'profile' }" class="w-full max-w-7xl mx-auto p-6 min-h-screen">
  ...
  @if (session('password_success'))
      <div 
          ...
          x-show="show"
          x-transition
          class="fixed top-6 right-6 bg-green-100 border border-green-300 text-green-800 
                 px-4 py-3 rounded-lg shadow-lg z-50 flex items-center gap-2"
      >
  ...
  <form x-show="tab === 'password'" 
        x-cloak 
        wire:submit.prevent="changePassword" 
        @password-changed.window="setTimeout(() => { tab = 'profile' }, 1500)"
    ...
    <div class="bg-white border border-gray-200 rounded-xl shadow-sm">
        ...
        <div>
          ...
          <div class="relative">
            <input 
              ...
              class="w-full py-2.5 px-3 pr-10 text-sm rounded-md border border-gray-300 
            ...
            <button type="button"
                    ...
                    class="absolute top-1/2 -translate-y-1/2 right-3 text-gray-500 hover:text-gray-700">
                <svg x-show="!showCurrent" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                        d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 
                         2.943 9.542 7-1.274 4.057-5.064 7-9.542 7S3.732 16.057 
                         2.458 12z"/>
                </svg>
                <svg x-show="showCurrent" class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
      ...
      <div class="p-6 pt-0 flex justify-end">
        <button type="submit"
                wire:loading.attr="disabled"
                wire:loading.class="opacity-50 cursor-not-allowed"
                class="py-2.5 px-5 text-sm font-semibold rounded-md bg-blue-600 text-white 
