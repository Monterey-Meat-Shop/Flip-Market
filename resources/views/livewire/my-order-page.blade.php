<div class="max-w-7xl mx-auto p-4 sm:p-6 bg-gray-50 min-h-screen">
  ...
  <div class="flex flex-wrap gap-6 text-md font-medium text-gray-600 mb-4 ">
    ...
    <button wire:click="setActiveTab('to_ship')" 
            class="cursor-pointer pb-2 border-b-2 {{ $activeTab === 'to_ship' ? 'border-blue-500 text-blue-600' : 'border-transparent hover:text-blue-600' }}">
      To ship
    </button>
    ...
    <!-- NEW FEATURE  -->
       <button 
            class="cursor-pointer pb-2 border-b-2 {{ $activeTab === 'return/refund' ? 'border-blue-500 text-blue-600' : 'border-transparent hover:text-blue-600' }}">
     Return/Refund
    </button>
