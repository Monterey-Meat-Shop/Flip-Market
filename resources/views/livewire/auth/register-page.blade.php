<div class="bg-gray-800 bg-cover bg-center w-full h-screen relative" style = "background-image: url('images/bg-shoe-store.png');" >
          ...
          <div class="text-center">
            ...
            <p class="mt-2 text-sm text-gray-600 ">
              Already have an account?
                 <a wire:navigate class="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none" href="/login">
                Sign in here
              </a>
            </p>
          </div>
          ...
          <form>
            <div class="grid gap-y-4">
              ...
              <div>
                ...
                <label for="name" class="block text-sm mb-2">First Name</label>
                </div>
                <div class="relative">
